...
### reg
回归测试环境回归测试环境，用于跑回归测试的地方。之所以不在UAT上跑回归测试而是建一个单独的环境，主要是为了隔离。reg环境比较稳定，不怎么进行代码变动。尤其是测试期间，用于跑回归测试的地方。之所以不在UAT上跑回归测试而是建一个单独的环境，主要是为了隔离。reg环境比较稳定，不怎么进行代码变动。尤其是测试期间回归测试环境，用于跑回归测试的地方。之所以不在UAT上跑回归测试而是建一个单独的环境，主要是为了隔离。reg环境比较稳定，不怎么进行代码变动。尤其是测试期间回归测试环境，用于跑回归测试的地方。之所以不在UAT上跑回归测试而是建一个单独的环境，主要是为了隔离。reg环境比较稳定，不怎么进行代码变动。尤其是测试期间回归测试环境，用于跑回归测试的地方。之所以不在UAT上跑回归测试而是建一个单独的环境，主要是为了隔离。reg环境比较稳定，不怎么进行代码变动。尤其是测试期间
